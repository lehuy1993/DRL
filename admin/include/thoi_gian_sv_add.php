...
if(isset($_POST['themmoi'])){
	...
	$Tgbatdausv=$_REQUEST['Tgbatdausv'];
    $Tgketthucsv=$_REQUEST['Tgketthucsv'];
    $MaHK = $_REQUEST['MaHK'];
    $Trangthai = $_REQUEST['Trangthai'];
    $dbAction=new CRUD();
	//Tạo mảng giá trị thêm
    $data = array(
                'Tgbatdausv' => $Tgbatdausv,
                'Tgketthucsv' =>$Tgketthucsv,
                'MaHK'      =>$MaHK,
                'Trangthai' =>$Trangthai,
            );
    ...
    $check= $dbAction->select(Table::tbthoigian_sv,$where);
	...
	if($dbAction->insert(Table::tbthoigian_sv,$data))
	{
                                ...
                                <div class="col-lg-8" style="padding-left: 150px;">
                                    ...
                                    <div class = "form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="Tgbatdausv" class="form-control" type="date" class="span4">
                                            <p class="help-block">yyyy/mm/dd</p>
                                        </div>
                                         <div class="form-group">
                                            <label>Thời gian kết thúc sinh viên</label>
                                            <input name="Tgketthucsv" class="form-control" type="date" class="span4">
                                            <p class="help-block">yyyy/mm/dd</p>
                                        </div>
                                        <div class="form-group">
