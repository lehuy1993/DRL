...
class Table {
    ...
    const tbquantri = 'quantri';
    const tblop = 'lop' ;
    const tbthoigian_sv = 'thoigian_sv';
    const tbthoigian_cb = 'thoigian_cb';
    const tbmaudrl = 'maudrl';
    const tbtieuchi = 'tieuchi';
    const tbnhomcon = 'nhomcon';
    const tbchitiet_tc = 'chitiettieuchi';
    const tbkqdrl = 'kqdrl' ;
    const tbhocky	='hocky';
    const tbkqdrl_sv = 'kqdrl_sv';
    const tbkqdrl_cb ='kqdrl_cb';
    const tbsinhvien ='sinhvien';
